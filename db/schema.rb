...
ActiveRecord::Schema.define(version: 2020_07_31_080942) do
  ...
  create_table "elements", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
